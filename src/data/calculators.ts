...
export const categories: CategoryMeta[] = [
  ...
  },
  {
    ...
    title: 'Finance & Money',
    icon: DollarSign,
    description: 'Budgets, loans, investments, taxes',
    color: 'from-green-500 to-emerald-500',
    calculators: [
      { id: 'budget_planner', title: 'Budget Planner', description: 'Plan monthly budget and savings goals', keywords: ['budget', 'expense', 'income', 'savings', 'planner', 'monthly'], complexity: 'advanced' },
      { id: 'expense_tracker', title: 'Expense Tracker Lite', description: 'Monthly cashflow and expense categorization', keywords: ['expense', 'tracker', 'cashflow', 'spending'], complexity: 'simple' },
      { id: 'savings_goal', title: 'Savings Tracker (FD/RD)', description: 'Calculate deposits and goal timelines', keywords: ['fd', 'rd', 'savings', 'goal', 'deposit', 'target'], complexity: 'advanced' },
      { id: 'loan_amortization', title: 'Loan Amortization', description: 'Full loan schedule and periodic payments', keywords: ['loan', 'amortization', 'schedule', 'payment', 'interest', 'principal'], complexity: 'advanced' },
      { id: 'debt_payoff', title: 'Debt / Credit Card Payoff', description: 'Strategies to pay off credit cards and debts', keywords: ['credit', 'card', 'payoff', 'debt', 'interest', 'apr', 'strategy'], complexity: 'advanced' },
      { id: 'mortgage', title: 'Mortgage / EMI', description: 'Loan payments with detailed schedule', keywords: ['mortgage', 'emi', 'loan', 'home', 'payment'], complexity: 'advanced' },
      ...
      { id: 'retirement_planner', title: 'Retirement Planner', description: 'Plan your retirement corpus and contributions', keywords: ['retirement', 'pension', 'corpus', 'planner', 'savings'], complexity: 'advanced' },
  ...
  },
  {
    ...
    icon: Building2,
    description: 'Margins, pricing, sales analytics',
    color: 'from-violet-500 to-purple-500',
    calculators: [
      { id: 'pricing', title: 'Pricing & Margin Calculator', description: 'Markup, Markdown, Tax-Inclusive/Exclusive pricing', keywords: ['pricing', 'markup', 'markdown', 'margin', 'selling', 'price', 'profit', 'tax'], complexity: 'advanced' },
      ...
      { id: 'reorder_point', title: 'Inventory Reorder Point', description: 'Calculate reorder point and suggested quantity', keywords: ['reorder', 'point', 'inventory', 'planning', 'safety', 'stock', 'lead', 'time'], complexity: 'simple' },
  ...
  },
  {
    ...
    icon: TrendingUp,
    description: 'ROI, engagement, campaigns',
  ...
  },
  {
    ...
    title: 'Real Estate',
    icon: Home,
    description: 'Property investment & mortgages',
    color: 'from-amber-500 to-orange-500',
    calculators: [
      { id: 'down_payment', title: 'Down Payment', description: 'Calculate home down payments and remaining loans', keywords: ['down', 'payment', 'home', 'house', 'mortgage', 'loan'], complexity: 'simple' },
      ...
      { id: 'rent_vs_buy', title: 'Rent vs Buy', description: 'Compare renting vs buying properties', keywords: ['rent', 'buy', 'compare', 'home', 'mortgage'], complexity: 'advanced' },
  ...
  },
  {
    ...
    icon: Activity,
    description: 'BMI, calories, one rep max',
    ...
    calculators: [
      ...
      { id: 'water_intake', title: 'Water Intake', description: 'Daily water requirement', keywords: ['water', 'hydration', 'drink'], complexity: 'simple' },
  ...
  },
  {
    ...
    icon: ShoppingCart,
    description: 'Discounts, taxes, unit prices',
    color: 'from-lime-500 to-green-500',
    calculators: [
      { id: 'discount', title: 'Discount Calculator', description: 'Calculate sale prices, discounts, and total savings', keywords: ['discount', 'sale', 'price', 'savings', 'percent off', 'coupon'], complexity: 'simple' },
      { id: 'sales_tax', title: 'Sales Tax / VAT', description: 'Calculate GST, VAT, and sales tax add/extract', keywords: ['tax', 'gst', 'vat', 'sales', 'subtotal'], complexity: 'simple' },
      { id: 'unit_price', title: 'Unit Price Compare', description: 'Find the price per unit and compare products', keywords: ['unit', 'price', 'per', 'grocery', 'compare', 'cheaper'], complexity: 'simple' },
      { id: 'tip_splitter', title: 'Tip Splitter', description: 'Calculate tips and split the bill among people', keywords: ['tip', 'bill', 'split', 'restaurant', 'gratuity'], complexity: 'simple' },
  ...
  },
  {
    ...
    title: 'Date & Time',
    icon: Clock,
    description: 'Age, durations, timezones',
  ...
  },
  {
    ...
    title: 'Home & DIY',
    icon: Home,
    description: 'Paint, flooring, concrete',
  ...
  },
  {
    ...
    title: 'Automotive',
    icon: Car,
    description: 'Fuel, efficiency, trip calculation',
  ...
  },
  {
    ...
    title: 'Photography',
    icon: Camera,
    description: 'Exposure, DOF, print sizing',
  ...
  },
  {
    ...
    title: 'Electrical',
    icon: Zap,
    description: "Ohm's law, power, resistors",
  ...
  },
  {
    ...
    icon: Leaf,
    description: 'Carbon footprint impact',
  ...
  },
  {
    ...
    icon: BarChart3,
    description: 'Analysis, mean, distribution',
  ...
  },
  {
    ...
    icon: Code,
    description: 'Subnets, encoding, CRON, UUIDs',
    color: 'from-purple-500 to-violet-500',
    calculators: [
      { id: 'json_csv', title: 'JSON ↔ CSV', description: 'Convert between JSON and CSV', keywords: ['json', 'csv', 'convert', 'data', 'format'], complexity: 'advanced' },
      ...
      { id: 'base64', title: 'Base64 Encode/Decode', description: 'Encode and decode Base64 strings', keywords: ['base64', 'encode', 'decode', 'string'], complexity: 'simple' },
      ...
      { id: 'cron', title: 'Cron Helper', description: 'Generate cron schedules', keywords: ['cron', 'scheduler', 'generator', 'linux', 'crontab'], complexity: 'simple' },
    ]
  },
  {
    id: 'hr_salary',
    title: 'HR & Salary',
    icon: Briefcase,
    description: 'Take-home, pay converter, raises',
    color: 'from-indigo-500 to-purple-500',
    calculators: [
      { id: 'take_home_pay', title: 'Take-Home Pay', description: 'Net salary planner with deductions', keywords: ['take', 'home', 'net', 'tax', 'gross', 'salary'], complexity: 'advanced' },
      { id: 'salary', title: 'Salary Converter', description: 'Hourly ↔ annual salary conversion', keywords: ['salary', 'hourly', 'annual', 'pay', 'wage'], complexity: 'simple' },
