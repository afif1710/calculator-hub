  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-3 gap-3">
        ...
        <label className="space-y-1"><span className="text-xs font-medium">Depth (in)</span><input placeholder="e.g. 5000" type="number" value={depth} onChange={(e) => setDepth(e.target.value)} className="w-full px-3 py-2 rounded-lg bg-secondary/50 border border-border focus:border-primary outline-none text-sm" min="0" /></label>
      </div>
